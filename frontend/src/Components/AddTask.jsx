...
const Addtask = () => {
    ...
    const dataValidation = () => {
        const { projectName, taskName, username, empId, startDate, endDate, description } = addTask;
                ...
                <div className="row text-center ">
                    ...
                    <div >
                        <form className="AddtaskForm">
                            ...
                            <input className="form-control" type="text" name="username" placeholder="Employee Name" value={addTask.username} onChange={inputHandler} /><br />
